...
* **GitHub**. If you spot a bug or have an idea for a feature please raise an issue on our [public roadmap](https://roadmap.speakeasy.com/roadmap)
* **Community**. Come chat with us on [Slack](http://go.speakeasy.com/slack). 
* **Email**. A real person wrote this. If you want to talk to me, email is the easiest way. Get in touch: nolan@speakeasy.com.
